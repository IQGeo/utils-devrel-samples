...
from exercise_rest_api import exerciseRestApi

r = exerciseRestApi("http://localhost/myworld_comms/", "admin", "_mywWorld_")

if len(sys.argv) < 2:
    raise ValueError("Provide design name as first arg")
